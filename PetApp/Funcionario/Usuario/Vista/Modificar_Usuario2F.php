...
<body id="fondox">
    ...
    <div id="padre">
        <div id="modificar" class="form-group">
            ...
            <?php
            require_once("../Controlador/Controlador_Modificar_Usuario2F.php");
            while($Usu=mysqli_fetch_row($resultado)){
                echo "
                    <form action='../Controlador/Controlador_Actualizar_Usuario2F.php' method='Post' enctype='multipart/form-data'>
                        <div id='centro'>   
